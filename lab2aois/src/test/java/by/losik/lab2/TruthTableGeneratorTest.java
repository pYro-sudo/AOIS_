...
class TruthTableGeneratorTest {
    ...
    void testGetDecimalRepresentation() throws Exception {
        ...
        long decimal = (long) invokePrivateMethod("getDecimalRepresentation");
        assertEquals(6, decimal);
    }

    @Test
    void testBuildIndexFormsAndTable() throws Exception {
        ...
        assertDoesNotThrow(TruthTableGenerator::printTruthTable);
    }
}